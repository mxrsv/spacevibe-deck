          ...
          <div class="a-hero">
            ...
            <div class="a-actions">
              <!-- Both installs wear the same outline variant (owner,
                   ...
                   one, and the white fill went with the hierarchy. Restored
                   above the quick-install block (owner, 2026-09-10) after the
                   curl card alone left visitors with no button to press; the
                   copy command stays the recommended path. -->
              <a
                class="a-quiet-cta"
              ...
              <!-- The server-rendered href is the releases page, and
                   upgradeReleaseLinks retargets it at the newest stable .dmg
                   — see download-links.js. -->
              <a
                class="a-quiet-cta"
                href="${RELEASES_URL}"
                target="_blank"
