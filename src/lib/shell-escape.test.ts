...
describe("shellEscapePath", () => {
  it("leaves a clean path untouched", () => {
    expect(shellEscapePath("/Users/me/dev/file.txt", "macos")).toBe(
      "/Users/me/dev/file.txt",
    );
  });

  it("escapes spaces", () => {
    expect(shellEscapePath("/Users/me/My File.txt", "macos")).toBe(
  ...
  it("keeps unicode (Vietnamese) but still escapes the space", () => {
    expect(shellEscapePath("/Users/me/Tài liệu", "macos")).toBe(
      "/Users/me/Tài\\ liệu",
    );
  });
