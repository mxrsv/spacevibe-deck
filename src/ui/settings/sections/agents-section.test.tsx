...
describe("AgentsSection", () => {
  ...
  it("explains that Add agent declares a new CLI identity", () => {
    mount();
    const row = addButton().closest(".cfg-row");
    expect(row?.querySelector(".cfg-row__desc")?.textContent).toContain("new CLI identity");
    expect(host.textContent).toContain("Add command");
  });
